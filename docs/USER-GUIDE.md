...
> **Authoritative exhaustive guide:** **[USER-GUIDE-COMPLETE.md](./USER-GUIDE-COMPLETE.md)** — every screen, form, Excel/Odoo workflow, validation, and E2E process. Prefer that document for training, UAT, and field-level work.
...
> **Need field-level detail?** This overview covers concepts, routines, and module walkthroughs. For an exhaustive screen-by-screen guide — every route, form field, button label, validation message, stub/mock flag, and cross-screen dependency — see **[USER-GUIDE-BY-SCREEN.md](./USER-GUIDE-BY-SCREEN.md)** (kept for navigation; **superseded in depth** by [USER-GUIDE-COMPLETE.md](./USER-GUIDE-COMPLETE.md)).
