...
def create_app() -> FastAPI:
    _app = FastAPI(
        title="IPE - Supply Chain Network",
        description="Supplier scorecard, RFQ workflow, and multi-tier supply chain visibility",
        version="0.1.0",
        lifespan=lifespan,
        docs_url="/docs",
        redoc_url="/redoc",
    )
    setup_observability(_app, service_name="scn-svc")
    setup_metrics(_app, service_name="scn-svc", version="9.3.0-p2")
