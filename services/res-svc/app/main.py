...
def create_app() -> FastAPI:
    _app = FastAPI(title="IPE - Resolution Recommender", description="Resolution scenario generation and ranking", version="0.1.0", lifespan=lifespan, docs_url="/docs", redoc_url="/redoc")
    setup_observability(_app, service_name="res-svc")
