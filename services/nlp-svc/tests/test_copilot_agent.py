...
async def test_agent_no_client_configured():
    with patch("app.core.copilot_agent._get_client", return_value=(None, None)):
...
async def test_agent_end_turn_response():
    ...
    with patch("app.core.copilot_agent._get_client", return_value=(mock_client, {"model": "m", "max_tokens": 100})):
