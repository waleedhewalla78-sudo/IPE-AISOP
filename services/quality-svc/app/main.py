...
def create_app() -> FastAPI:
    _app = FastAPI(
        title="IPE - Quality Service",
        description="Statistical Process Control, defect prediction, and quality event management",
        version="0.1.0",
        lifespan=lifespan,
        docs_url="/docs",
        redoc_url="/redoc",
    )
    setup_observability(_app, service_name="quality-svc")
    setup_metrics(_app, service_name="quality-svc", version="9.3.0-p2")
