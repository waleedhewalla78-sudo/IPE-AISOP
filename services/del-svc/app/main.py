...
def create_app() -> FastAPI:
    _app = FastAPI(title="IPE - Delay Analyst", description="Root cause classification and trend analytics", version="0.1.0", lifespan=lifespan, docs_url="/docs", redoc_url="/redoc")
    setup_observability(_app, service_name="del-svc")
